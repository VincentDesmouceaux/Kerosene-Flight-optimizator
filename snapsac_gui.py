...
import matplotlib
# Backend GUI explicite pour la fenêtre
...
class App:
    def __init__(self, root):
        ...
        ttk.Label(self.main, text="Simulation — Conso totale / Conso par passager / Durée",
                  font=("Helvetica", 14, "bold")).grid(row=0, column=0, sticky="w", pady=(0, 6))

        # Figure avec 1x3 subplots
        ...
        for metric in METRICS:
            ...
            self.wind_lines[metric] = ax.axvline(
                0, color="#444", lw=1.2, ls="--", alpha=0.6)
    ...
    def _reset_sequence(self, seq):
        ...
        self.fig.suptitle(f"Snapsac — {self.direction} | {self.distance} km | {self.pax} pax",
